...
export default function RackesTable({ data, loading, dele, edit }: Props) {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        accessor: "numberOfFibers",
        width: 300,
      },
      {
        Header: translate("Adapter turi"),
        accessor: "typeOfAdapter",
        width: 300,
      },
      {
        Header: translate("Portlar soni"),
        accessor: "countOfPorts",
        width: 300,
      },
      {
  ...
  return <Table loading={false} columns={columns} data={data} selectRowCheckbox={noop} />;
}
